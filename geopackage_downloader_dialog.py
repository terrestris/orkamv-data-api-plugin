...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'geopackage_downloader_dialog_base.ui'))


class GeopackageDownloaderDialog(QtWidgets.QDialog, FORM_CLASS):
    ...
    def __init__(self, parent=None):
        """Constructor."""
        super(GeopackageDownloaderDialog, self).__init__(parent)
